...
def save_artifacts(args, epoch, model, class_parameters, inst_parameters, labels_dict=None):
    ...
    Args:
        ...
        labels_dict (dict): Dictionary containing ground-truth labels and the labels with which we have trained the model.
    """
    artifacts = {
            'epoch': epoch + 1,
            'arch': args.arch,
